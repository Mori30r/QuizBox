...
class Teacher(models.Model):
    user = models.ForeignKey(UserBaseQuizBox, on_delete=models.CASCADE, related_name='teacher')
...
class Student(models.Model):
    user = models.OneToOneField(UserBaseQuizBox, on_delete=models.CASCADE, related_name='student')
