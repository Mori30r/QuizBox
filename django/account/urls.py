...
urlpatterns = [
    ...
    path('list_approved_students/<int:teacher_id>/approved_students/',
         views.list_approved_students, name='approved_students'),
    path('list_approved_teachers_by_student/<int:student_id>/approved_teachers/',
